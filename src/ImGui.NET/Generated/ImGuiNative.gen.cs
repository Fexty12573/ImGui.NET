...
namespace ImGuiNET
{
    ...
    {
        public const string LibName="cimgui";
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte* igGetKeyChordName(ImGuiKey key_chord);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte igImageButtonEx(uint id, IntPtr texture_id, Vector2 image_size, Vector2 uv0, Vector2 uv1, Vector4 bg_col, Vector4 tint_col, ImGuiButtonFlags flags);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte igIsKeyChordPressed_ID(ImGuiKey key_chord, uint owner_id, ImGuiInputFlags flags);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte igItemHoverable(ImRect bb, uint id, nint item_flags);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern ImGuiLayoutType ImGuiInternal_GetCurrentLayoutType(uint window_id);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImGuiInternal_UpdateItemRect(uint window_id, Vector2 min, Vector2 max);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
